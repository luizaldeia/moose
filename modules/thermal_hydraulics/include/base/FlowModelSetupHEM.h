...
/**
 * Helper class to set up some objects for HEM flow
 */
class FlowModelSetupHEM : public FlowModelSetup
{
public:
  FlowModelSetupHEM(const InputParameters & params);
...
protected:
  ...
  const UserObjectName _fp_hem_name;
