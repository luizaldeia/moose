 ...
 */
class ClosuresHEMBase : public ClosuresBase
{
public:
  ClosuresHEMBase(const InputParameters & params);
...
protected:
   ...
   */
  void addWallFrictionFunctionMaterial(const FlowChannelHEM & flow_channel) const;
   ...
   * @param[in] flow_channel   Flow channel component
   */
  void addAverageWallTemperatureMaterial(const FlowChannelHEM & flow_channel) const;
