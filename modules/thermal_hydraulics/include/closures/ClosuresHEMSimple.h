 ...
 */
class ClosuresHEMSimple : public ClosuresHEMBase
{
public:
  ClosuresHEMSimple(const InputParameters & params);
...
protected:
   ...
   */
  void addWallTemperatureFromHeatFluxMaterial(const FlowChannelHEM & flow_channel) const;
