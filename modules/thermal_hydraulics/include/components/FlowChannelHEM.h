 ...
 */
class FlowChannelHEM : public FlowChannelBase
{
public:
  FlowChannelHEM(const InputParameters & params);
  ...
  virtual const THM::FlowModelID & getFlowModelID() const override { return THM::FM_HEM; }
