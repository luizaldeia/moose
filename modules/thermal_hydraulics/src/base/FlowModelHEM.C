...
const std::string FlowModelHEM::DENSITY = "rho";
const std::string FlowModelHEM::FRICTION_FACTOR_DARCY = "f_D";
const std::string FlowModelHEM::DYNAMIC_VISCOSITY = "mu";
const std::string FlowModelHEM::HEAT_TRANSFER_COEFFICIENT_WALL = "Hw";
const std::string FlowModelHEM::HYDRAULIC_DIAMETER = "D_h";
const std::string FlowModelHEM::PRESSURE = "p";
const std::string FlowModelHEM::RHOA = "rhoA";
const std::string FlowModelHEM::RHOEA = "rhoEA";
const std::string FlowModelHEM::RHOUA = "rhouA";
const std::string FlowModelHEM::SOUND_SPEED = "c";
const std::string FlowModelHEM::SPECIFIC_HEAT_CONSTANT_PRESSURE = "cp";
const std::string FlowModelHEM::SPECIFIC_HEAT_CONSTANT_VOLUME = "cv";
const std::string FlowModelHEM::SPECIFIC_INTERNAL_ENERGY = "e";
const std::string FlowModelHEM::SPECIFIC_TOTAL_ENTHALPY = "H";
const std::string FlowModelHEM::SPECIFIC_VOLUME = "v";
const std::string FlowModelHEM::TEMPERATURE = "T";
const std::string FlowModelHEM::THERMAL_CONDUCTIVITY = "k";
const std::string FlowModelHEM::VELOCITY = "vel";
const std::string FlowModelHEM::VELOCITY_X = "vel_x";
const std::string FlowModelHEM::VELOCITY_Y = "vel_y";
const std::string FlowModelHEM::VELOCITY_Z = "vel_z";
const std::string FlowModelHEM::REYNOLDS_NUMBER = "Re";
const std::string FlowModelHEM::VOID_FRACTION = "alpha";

InputParameters
FlowModelHEM::validParams()
{
...
registerMooseObject("ThermalHydraulicsApp", FlowModelHEM);

FlowModelHEM::FlowModelHEM(const InputParameters & params)
  : FlowModel(params),
...
FlowModelHEM::addMooseObjects()
{
  ...
  {
    std::string class_name = "ADFluidPropertiesHEM3EqnMaterial";
    InputParameters params = _factory.getValidParams(class_name);
  ...
  {
    const std::string class_name = "ADDynamicViscosityHEMMaterial";
    InputParameters params = _factory.getValidParams(class_name);
    params.set<std::vector<SubdomainName>>("block") = _flow_channel.getSubdomainNames();
    params.set<UserObjectName>("fp_hem") = _fp_name;
    ...
    params.set<MaterialPropertyName>("T") = {TEMPERATURE};
    params.set<MaterialPropertyName>("p") = {PRESSURE};
    params.set<MaterialPropertyName>("alpha") = {VOID_FRACTION};
...
void
FlowModelHEM::addRDGMooseObjects()
{
...
void
FlowModelHEM::addRDGAdvectionDGKernels()
{
  // mass
