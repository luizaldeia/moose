...
#include "ADNumericalFlux3EqnDGKernelHEM.h"
#include "ADNumericalFlux3EqnBase.h"
#include "MooseVariable.h"
#include "THMIndices3EqnHEM.h"

registerMooseObject("ThermalHydraulicsApp", ADNumericalFlux3EqnDGKernelHEM);

InputParameters
ADNumericalFlux3EqnDGKernelHEM::validParams()
{
...
ADNumericalFlux3EqnDGKernelHEM::ADNumericalFlux3EqnDGKernelHEM(const InputParameters & parameters)
...
ADReal
ADNumericalFlux3EqnDGKernelHEM::computeQpResidual(Moose::DGResidualType type)
{
...
ADNumericalFlux3EqnDGKernelHEM::getIndexMapping() const
{
  ...
  ADReal teste1 = _rhoA_var;
  ADReal teste2 = _rhouA_var;
  ADReal teste3 = _rhoEA_var;

  std::cout << "\n";
  std::cout << "========================================\n";
  std::cout << "ADNumericalFlux3EqnDGKernelHEM \n";
