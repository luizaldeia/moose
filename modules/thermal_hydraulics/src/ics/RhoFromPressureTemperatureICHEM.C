...
#include "RhoFromPressureTemperatureICHEM.h"
#include "HEM.h"

registerMooseObject("ThermalHydraulicsApp", RhoFromPressureTemperatureICHEM);

InputParameters
RhoFromPressureTemperatureICHEM::validParams()
{
...
RhoFromPressureTemperatureICHEM::RhoFromPressureTemperatureICHEM(const InputParameters & parameters)
...
Real
RhoFromPressureTemperatureICHEM::value(const Point & /*p*/)
{
  ...
  ADReal teste = MetaPhysicL::raw_value(rho);

  // std::cout << "\n";
  // std::cout << "========================================\n";
  // std::cout << "RhoFromPressureTemperatureICHEM \n";
  // std::cout << "rho -----------> " << teste.value() << "\n";
  // std::cout << "========================================\n";
  // std::cout << "\n";

  return MetaPhysicL::raw_value(rho);
}
