...
#include "ADBoundaryFlux3EqnGhostMassFlowRateTemperatureHEM.h"
#include "THMIndices3Eqn.h"
#include "HEM.h"
#include "Numerics.h"

registerMooseObject("ThermalHydraulicsApp", ADBoundaryFlux3EqnGhostMassFlowRateTemperatureHEM);

InputParameters
ADBoundaryFlux3EqnGhostMassFlowRateTemperatureHEM::validParams()
{
...
ADBoundaryFlux3EqnGhostMassFlowRateTemperatureHEM::
    ADBoundaryFlux3EqnGhostMassFlowRateTemperatureHEM(const InputParameters & parameters)
...
std::vector<ADReal>
ADBoundaryFlux3EqnGhostMassFlowRateTemperatureHEM::getGhostCellSolution(
